...
```{r plot horses, fig.width=10, fig.height=3, fig.cap="Figure 1. Plot of all the Provinces", fig.align='center'}
...
knitr::kable(max_horses, caption = "Table 1. Population of Horses in Canada") |>
  kableExtra::kable_styling(full_width = FALSE)
```

Below we zoom in and look at the province of `r params$province`:

```{r plot province, fig.width=5, fig.height=4, fig.cap="Figure 2. Plot of the filtered Province", fig.align='center'}
...
## Reproducibility  with CLI 

To render using console: `rmarkdown::render("doc/hist_horse_pop.Rmd")`	
To render using terminal: `Rscript -e "rmarkdown::render('doc/hist_horse_pop.Rmd')"`	
To render using terminal with params: `Rscript -e "rmarkdown::render('doc/hist_horse_pop.Rmd', output_format = 'pdf_document', params=list(province='British Columbia'))"`	
